...
Model: Conv3d unit has single convolutional layers

Experimental Setting:Training and valid code for 24-word preprocessed dataset
...
# checkpoint
filepath ="/hpctmp/e0703421/model/model_24_01112021/model-improvement-{epoch:02d}-{val_accuracy:.2f}.hdf5"
csv_pth ="/hpctmp/e0703421/model/model_24_01112021/model-improvement-{epoch:02d}-{val_accuracy:.2f}"
