...
os.chdir("/hpctmp/e0703421/01_PRS_Dataset/train_100_1000")
train_video_filepaths=(glob.glob("processed_**.mp4"))
os.chdir("/hpctmp/e0703421/01_PRS_Dataset/valid_100_50")
...
for index in tqdm(range(0, len(train_video_filepaths))):
    cap = cv2.VideoCapture("/hpctmp/e0703421/01_PRS_Dataset/train_100_1000/"+ train_video_filepaths[index])
...
for index in tqdm(range(0, len(valid_video_filepaths))):
    cap = cv2.VideoCapture("/hpctmp/e0703421/01_PRS_Dataset/valid_100_50/"+ valid_video_filepaths[index])
    #print(train_video_filepaths[index])
    #print(cap.isOpened())
    nframe = int(cap.get(cv2.CAP_PROP_FRAME_COUNT))
    #print(nframe)
...
# checkpoint
filepath ="/hpctmp/e0703421/model/model_100_11112021/model-improvement-{epoch:02d}-{val_accuracy:.2f}.hdf5"
csv_pth ="/hpctmp/e0703421/model/model_100_11112021/model-improvement-{epoch:02d}-{val_accuracy:.2f}"
