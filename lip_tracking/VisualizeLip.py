...
ap.add_argument("-r", "--render", required=True,
                help="path to video file with the rendered rectangle")
...
# Define the writer for rendered file
#rWriter = skvideo.io.FFmpegWriter(args["render"])

# Define the writer for output file
oWriter = skvideo.io.FFmpegWriter(args["output"])
...
for frame in reader.nextFrame():
    ...
    # My experiment
    #rWriter.writeFrame(frame)
    #write video of just gray mouth
    oWriter.writeFrame(mouth_gray)
    counter += 1
